<template>
  <v-row>
    <v-col>
      <v-card-title class="title2">Menu</v-card-title>
      <v-col cols="12">
        <v-card
          style="
            display: flex;
          ...
          class="cards"
        >
          <v-card-item v-for="(menu, i) in menus" :key="i" small>
            <div>
              <v-card
                color="red darken-2"
                class="white--text"
